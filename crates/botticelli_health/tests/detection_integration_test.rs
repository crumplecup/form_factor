...
fn test_logo_size_structure() {
    ...
    let size = LogoSize { width: 200, height: 150 };
...
fn test_ocr_config_modes() {
    use form_factor::{EngineMode, PageSegmentationMode, OCRConfig};
    ...
    assert_eq!(config.page_segmentation_mode, PageSegmentationMode::SingleBlock);
}
