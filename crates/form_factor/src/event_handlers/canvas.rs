...
impl CanvasEventHandler {
    /// Handle zoom changed
    #[tracing::instrument(skip(canvas), fields(zoom))]
    ...
    /// Handle pan changed
    #[tracing::instrument(skip(canvas), fields(x, y))]
    ...
    #[tracing::instrument(skip(canvas), fields(tool_name))]
    ...
    #[tracing::instrument(skip(canvas), fields(visible))]
    ...
    #[tracing::instrument(skip(canvas), fields(locked))]
    ...
    #[tracing::instrument(skip(canvas))]
