...
#[test]
fn circle_creates_with_valid_params() -> Result<(), form_factor_drawing::ShapeError> {
...
#[test]
fn polygon_creates_with_three_points() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
...
#[test]
fn polygon_creates_with_many_points() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_translates_correctly() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_translates_correctly() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_translates_correctly() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_rotates_around_pivot() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_rotates_90_degrees() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_rotates_180_degrees() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rotation_360_degrees_returns_to_original() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_set_corner_updates_shape() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_set_vertex_updates_shape() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_set_vertices_replaces_all() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_set_radius_updates_radius() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_set_center_updates_center() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_contains_interior_point() -> Result<(), form_factor_drawing::ShapeError> {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
