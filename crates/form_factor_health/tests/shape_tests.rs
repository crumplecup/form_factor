...
#[test]
fn polygon_rejects_too_few_points() {
...
#[test]
fn shape_rejects_nan_coordinates() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn shape_rejects_infinity_coordinates() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_rejects_degenerate_shape() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn error_captures_location_info() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_creates_with_valid_params() {
...
#[test]
fn polygon_creates_with_three_points() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
...
#[test]
fn polygon_creates_with_many_points() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_translates_correctly() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_translates_correctly() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_translates_correctly() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_rotates_around_pivot() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;

    let mut circle = Circle::new(Pos2::new(10.0, 0.0), 2.0, stroke, fill).unwrap();
...
#[test]
fn rectangle_rotates_90_degrees() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_rotates_180_degrees() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
fn rotation_360_degrees_returns_to_original() {
    ...
    let mut circle = Circle::new(original_center, 5.0, stroke, fill).unwrap();
...
#[test]
fn rectangle_set_corner_updates_shape() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_set_vertex_updates_shape() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_set_vertices_replaces_all() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_set_radius_updates_radius() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_set_center_updates_center() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
fn circle_contains_interior_point() {
    ...
    let circle = Circle::new(Pos2::new(10.0, 10.0), 5.0, stroke, fill).unwrap();
...
fn polygon_contains_interior_point() {
    ...
    let poly = PolygonShape::from_points(points, stroke, fill).unwrap();
...
#[test]
fn polygon_center_calculates_centroid() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_center_calculates_centroid() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn circle_builder_creates_valid_circle() {
...
#[test]
fn circle_builder_uses_default_name() {
    use form_factor::CircleBuilder;
...
#[test]
fn handles_very_large_coordinates() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn polygon_with_out_of_bounds_vertex_index() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
...
#[test]
fn rectangle_with_negative_coordinates() {
    let stroke = Stroke::new(1.0, Color32::BLACK);
    let fill = Color32::TRANSPARENT;
